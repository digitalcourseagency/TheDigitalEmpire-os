...
import { LayoutDashboard, FileText, Lightbulb, BarChart2, Target, Zap, Rocket, Camera, BookOpen, Flame, TrendingUp, Users } from "lucide-react";
const nav = [
  ...
  return (
    <aside style={{ width: 220, minHeight: "100vh", background: "#FDFCFA", borderRight: "1px solid #EDE8E1", padding: "24px 12px", display: "flex", flexDirection: "column", gap: 4, flexShrink: 0 }}>
      <div style={{ padding: "4px 12px 20px" }}>
        <div style={{ fontFamily: "Georgia,serif", fontSize: 22, letterSpacing: "0.04em", color: "#1A1917" }}>Ash Couture</div>
